...
// Module: HatsuYakitori.Upstream.WittFoundation
...
LEAN_EXPORT lean_object* initialize_hatsu_x2dyakitori_x2dproof_HatsuYakitori_Upstream_WittFoundation(uint8_t builtin) {
lean_object * res;
