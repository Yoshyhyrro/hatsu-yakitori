...
// Module: HatsuYakitori.Downstream.Topological
...
LEAN_EXPORT lean_object* initialize_hatsu_x2dyakitori_x2dproof_HatsuYakitori_Downstream_Topological(uint8_t builtin) {
lean_object * res;
