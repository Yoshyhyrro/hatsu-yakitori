...
namespace HatsuYakitori.GaloisLeechDiagram
...
/-- Group homomorphism from Galois group to Mathieu group -/
variable (φ : G24 →* M24)
...
theorem diagram2_commutes (m : M24) :
    ψ m = ψ (ι (π m)) := by
  -- This depends on properties of ι and π
  simp [ψ, ψ_global, ψ_p_adic, v_p]
...
end HatsuYakitori.GaloisLeechDiagram
